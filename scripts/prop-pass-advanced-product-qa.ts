...
import { buildDailyRiskCalendar, buildPayoutPlanner, calculateAccountSurvival, calculateRulesComplianceScore, calendarFactFromPipelineOutput, createBreachReplay, RULES_COMPLIANCE_WEIGHTS, type PayoutReadinessValues, type TradingOsResult } from "../src/propPass/tradingOs/index";
...
assert.equal(calendarFactFromPipelineOutput({ dailyPlan: { values: null } } as never), null);

...
const plan = Object.freeze({ calculationVersion: PROP_PASS_CALCULATION_VERSION, id: "p", generatedAt: "x", accountId: "a", tradingDay: "d", context: "challenge" as const, mode: "balanced" as const, maximumRiskTodayMinor: 100, riskPerTradeMinor: 50, maximumTrades: 2, stopAfterLosses: 2, profitLockMinor: null, preferredInstrument: null, allowedSessionId: null, instrumentSpecificationVersion: "qa-v1", hardLimitSnapshot: Object.freeze({ dailyLossRemainingMinor: 100, maximumLossRemainingMinor: 100, drawdownRemainingMinor: 100 }) });

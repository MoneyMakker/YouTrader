...
22. Final persistence schema and RLS — IN PROGRESS; expanded production migration approval checkpoint identifies exact 16-file ordered set + SHA-256 in `docs/releases/1.6.1/PPOS-117_EXPANDED_PRODUCTION_MIGRATION_APPROVAL.md`; Build 116 staging compat PASS; clean prod-baseline rehearsal FAIL → PRODUCTION MIGRATION READY NO; production apply still pending expanded PO authorization after clean rehearsal.

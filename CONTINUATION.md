...
- Polished professional export visuals: Achievement share cards now render as premium trader status cards with local deterministic tiers and real journal attributes; Share P&L/Save Image cards use a cleaner vertical professional layout; Monthly PDF has a stronger institutional performance-report header and compact readable metric hierarchy.
- Upgraded shareable trader cards after visual QA feedback: Share P&L/Save Image and Achievement/Unlocked badge cards now use a premium collectible trader-card layout with large bull emblem, score/tier, gold/purple/green frame treatment, icon rail, and dense real trading stat blocks without copying EA/FIFA/FC assets.
- Polished Monthly PDF into a more institutional performance report: stronger header hierarchy, compact metric sections, localized static labels where possible, footer logo/CTA, and a real SVG equity chart with grid/zero-line/markers instead of heavy filled shapes.

...
const PROHIBITED_PROPERTY = /(email|phone|full.?name|name$|password|passcode|token|secret|authorization|cookie|api.?key|brokerage|account.?number|private.?note|note.?body|screenshot|image|voice|audio|order.?id|payment|card)/i;

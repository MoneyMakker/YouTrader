...
export const ydlSemanticColorsDark: YdlSemanticColors = {
  ...
  surface: {
    ...
    selected: ydlPrimitiveColor.greenSoft,
  },
  text: {
  ...
  action: {
    // Lime is the primary interactive accent (tabs, chips, selected controls).
    // Purple (accent400) remains available as intentional secondary/premium, not default selected.
    primary: ydlPrimitiveColor.green400,
    primaryPressed: ydlPrimitiveColor.greenPressed,
    primaryText: ydlPrimitiveColor.inkOnLime,
    ...
    tertiaryText: ydlPrimitiveColor.green400,
...
export const ydlColor = {
  ...
  AccentSecondary: ydlPrimitiveColor.accent400,
  AccentGlow: ydlPrimitiveColor.greenSoft,
  AccentPremium: ydlPrimitiveColor.accent400,
  TextOnAccent: ydlSemanticColorsDark.action.primaryText,
